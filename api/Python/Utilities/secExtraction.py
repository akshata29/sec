...
def EdgarIngestion(req):
    ...
    try:
      ...
      # Filter out years that are not related
        ...
        logging.info("Filing types are " + str(config['filing_types']))
        ...
        if df is not None and len(df) > 0:
            ...
            logging.info(f'\nNo filings to download. Please check your configuration.')
            return "No filings to download. Please check your configuration."
